...
public class QuestionController {
    ...
    @PostMapping("/local")
    public ResponseEntity<Void> CriarBlocoQuestão(@RequestBody QuestionResponse questionRequest) {
    ...
    @GetMapping("/local/{id}")
    public ResponseEntity<QuestionResponse> BuscarBlocoQuestão(@PathVariable long id) {
    ...
    @PutMapping("/local/{id}")
    public ResponseEntity<Void> AtualizarBloco(@PathVariable long id, @RequestBody QuestionResponse questionRequest) {
    ...
    // METODOS HTTP PARA PUXAR/ATUALIZAR E DELETAR UMA QUESTÃO DE UM BLOCO
    ...
    public ResponseEntity<Void> DeletarQuestão(@RequestParam long id, @RequestParam long questionId) {
